...
class FirebaseAuth {
  ...
  // In firebase-auth.js, update the signUp method:
...
async signUp(email, password, userData) {
    ...
    try {
        ...
        // Auto-login happens automatically with createUserWithEmailAndPassword
        ...
        this.showNotification(`Welcome ${userData?.name || email}! Your account has been created.`, 'success');
        
        return { 
            success: true, 
            user: userCredential.user,
            autoLoggedIn: true  // Indicate auto-login happened
        };
    } catch (error) {
