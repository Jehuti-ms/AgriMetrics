...
// SalesRecord Module - Fixed Registration Pattern
const SalesRecordModule = {
        ...
        this.element.innerHTML = `
            <div class="module-container">
                ...
                <div class="glass-card" style="padding: 24px; margin-bottom: 24px;">
                    <h3 style="color: var(--text-primary); margin-bottom: 16px; font-size: 18px;">Filter Sales</h3>
                    <div class="filter-group">
                        ...
                        <input type="text" id="search-filter" class="filter-input" placeholder="Search sales...">
                        <button class="btn-outline" id="clear-filters-btn">Clear</button>
                    </div>
                </div>
                ...
                <div class="glass-card" style="padding: 24px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                        ...
                        <button class="btn-primary" id="show-all-sales-btn">View All</button>
                    </div>
    ...
    renderSalesTable() {
        ...
        const recentSales = this.sales.slice(0, 10); // Show only recent 10
    ...
    setupEventListeners() {
        ...
        if (reportBtn) {
            reportBtn.addEventListener('click', () => this.generateSalesReport());
        }
    ...
    generateSalesReport() {
        ...
        alert(`Sales Report:\n\n` +
              `Total Sales: ${count}\n` +
              `Total Revenue: ${this.formatCurrency(total)}\n` +
              `Average Sale: ${this.formatCurrency(avg)}\n` +
    ...
    showReceipt(sale) {
        ...
        const receiptHTML = `
            <h3>Receipt: ${sale.receiptId}</h3>
            <p>Date: ${sale.date}</p>
            <p>Product: ${sale.product}</p>
            <p>Amount: ${this.formatCurrency(sale.grandTotal)}</p>
