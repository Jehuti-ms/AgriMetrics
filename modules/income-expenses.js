        ...
        this.element.innerHTML = `
            <div id="income-expenses" class="module-container">
              ...
              <div class="income-card">
                <h2 class="module-section-title">Quick Actions</h2>
                <div class="income-grid">
                  <button class="income-action-btn">💰 Quick Income</button>
                  <button class="income-action-btn">🧾 Quick Expense</button>
                  <button class="income-action-btn">📊 View Reports</button>
                  <button class="income-action-btn">📂 Categories</button>
                </div>
              </div>
            
              <!-- Financial Overview -->
              <div class="income-card">
                <h2 class="module-section-title">Financial Overview</h2>
                <div class="income-grid">
                  <div class="income-stat-card"><div class="stat-value">$0.00</div><div class="stat-label">This Month</div></div>
                  <div class="income-stat-card"><div class="stat-value">$0.00</div><div class="stat-label">Avg Monthly</div></div>
                  <div class="income-stat-card"><div class="stat-value">0</div><div class="stat-label">Transactions</div></div>
                  <div class="income-stat-card"><div class="stat-value">0</div><div class="stat-label">Categories</div></div>
                  <div class="income-stat-card"><div class="stat-value">$0.00</div><div class="stat-label">Current Balance</div></div>
                </div>
              </div>
              ...
              <div class="income-card">
                <div class="activity-header">
                  <h2 class="module-section-title">Recent Transactions</h2>
              ...
              <!-- Expense Categories -->
              <div class="income-card">
                <h2 class="module-section-title">Expense Categories</h2>
                <div class="dashboard-activity-list">
              ...
              <div class="income-footer">
                ...
                <div class="income-modal-triggers">
                  <button class="income-action-btn" onclick="openImportModal()">📥 Import Data</button>
