...
/* Fix for import receipts modal being taller */
#import-receipts-modal .popout-modal-content {
    max-width: 800px !important;
    max-height: 85vh !important;
}
...
/* Import receipts modal body needs more space */
#import-receipts-modal .popout-modal-body {
    padding: 0 !important;
...
/* Medium screens (tablets) - FIX FOR BUTTON OVERFLOW */
@media (min-width: 768px) and (max-width: 1199px) {
    ...
    /* CRITICAL: Prevent footer button overflow on medium screens */
    .popout-modal-footer {
        flex-wrap: wrap !important;
        justify-content: center !important;
        gap: 10px !important;
...
/* Make sure camera buttons don't overflow */
#camera-section .camera-controls {
    display: flex;
    gap: 12px;
    justify-content: center;
