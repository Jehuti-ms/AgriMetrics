...
showCameraInterface() {
    ...
    this.element.innerHTML = `
            ...
            .popout-modal-content {
                ...
                max-width: 600px !important;
                width: 90% !important;
                max-height: calc(100vh - 40px) !important; /* Account for modal padding */
                overflow: hidden !important;
                display: flex !important;
                flex-direction: column !important;
                margin: auto !important;
                position: relative !important;
                z-index: 1000000 !important;
                top: 20px !important; /* Push down from top of modal */
            }
            ...
            .popout-modal-body {
                ...
                overflow-y: auto !important;
                flex: 1 !important;
                max-height: calc(100vh - 180px) !important; /* Account for header and footer */
            }
            ...
            /* ==================== FIXED MODAL FOOTER BUTTON OVERFLOW ==================== */
            .popout-modal-footer {
                position: sticky !important;
                bottom: 0 !important;
                background: white !important;
            ...
            @media (max-width: 768px) {
                .popout-modal {
                    padding: 10px !important;
                    align-items: flex-start !important;
                    padding-top: 60px !important; /* Space for navbar on mobile */
                }
                
                .popout-modal-content {
                    width: 95% !important;
                    max-height: calc(100vh - 70px) !important; /* Less height on mobile */
                    top: 0 !important;
            ...
            @media (min-width: 600px) and (max-width: 1024px) {
                ...
                /* Adjust footer for medium screens */
                .popout-modal-footer {
                    padding: 20px 24px !important;
                }
            ...
            /* ==================== SPECIFIC MODAL FOOTER FIXES ==================== */
            
            /* Import receipts modal footer specific */
            #import-receipts-modal .popout-modal-footer {
                justify-content: space-between !important;
            }
            ...
            /* Camera control buttons in import modal */
            #camera-section .camera-controls {
                display: flex !important;
                gap: 12px !important;
                justify-content: center !important;
            ...
            /* Import receipts content specific */
            ...
            /* ==================== SPECIFIC FIXES FOR IMPORT RECEIPTS MODAL ==================== */
#import-receipts-modal {
    position: fixed !important;
    top: 0 !important;
    left: 0 !important;
...
/* BODY FIX - Make it taller and scrollable */
#import-receipts-modal .popout-modal-body {
    padding: 0 !important;
    overflow-y: auto !important;
    flex: 1 !important;
...
#import-receipts-modal .import-receipts-container {
...
/* FOOTER FIX - Ensure buttons are always visible */
#import-receipts-modal .popout-modal-footer {
    padding: 16px 24px !important;
    border-top: 1px solid #e5e7eb !important;
    display: flex !important;
...
/* FOOTER BUTTON FIXES - Make them fit properly */
#import-receipts-modal .popout-modal-footer .btn {
    min-width: 120px !important;
...
/* Cancel button */
#import-receipts-modal .popout-modal-footer .btn-outline {
    min-width: 120px !important;
}

/* ==================== RESPONSIVE FIXES FOR IMPORT RECEIPTS MODAL ==================== */

/* Large screens (desktop) - Ensure modal is above navbar */
...
/* MEDIUM SCREENS FIX - Critical for button visibility */
@media (min-width: 768px) and (max-width: 1199px) {
    ...
    /* CRITICAL FOOTER FIX FOR MEDIUM SCREENS */
    #import-receipts-modal .popout-modal-footer {
        flex-wrap: wrap !important;
        gap: 10px !important;
        padding: 14px 20px !important;
    ...
    /* Specific button arrangement for medium screens */
    #import-receipts-modal #process-receipts-btn {
        order: 1 !important;
        flex: 2 !important;
    ...
    #import-receipts-modal .btn-outline {
        order: 2 !important;
        flex: 1 !important;
        min-width: 100px !important;
...
@media (max-width: 767px) {
    ...
    /* FOOTER FIX for small screens - Stack vertically */
    #import-receipts-modal .popout-modal-footer {
        flex-direction: column !important;
        gap: 8px !important;
        padding: 12px 16px !important;
...
/* ==================== CAMERA SECTION FIXES INSIDE MODAL ==================== */
#import-receipts-modal #camera-section {
    width: 100%;
    height: 100%;
}

#import-receipts-modal .camera-preview-container {
    width: 100%;
    height: 400px;
    background: #000;
    border-radius: 12px;
...
#import-receipts-modal #camera-preview {
    width: 100% !important;
    height: 100% !important;
    object-fit: cover;
    display: block;
...
/* Camera controls inside modal */
#import-receipts-modal #camera-section .btn {
    min-width: 120px;
    padding: 12px 16px;
    font-size: 14px;
    white-space: nowrap;
...
/* Ensure import receipts modal is on top of everything */
#import-receipts-modal {
    z-index: 99999 !important;
}
