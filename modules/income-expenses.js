...
// ==================== CROPPER METHOD ====================
// ==================== FULL CROPPER METHOD WITH GREEN CIRCULAR BUTTONS ====================
            ...
            ">
                ...
                ">
                    ...
                    <div style="
                        ...
                        flex-wrap: wrap;
                    ">
                        <button id="zoom-in-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                        ...
                        ">🔍+</button>
                        <button id="zoom-out-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                            ...
                            box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3);
                        ">🔍-</button>
                        <button id="rotate-left-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                            ...
                            box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3);
                        ">↺</button>
                        <button id="rotate-right-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                            ...
                            box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3);
                        ">↻</button>
                        <button id="flip-horizontal-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                            ...
                            box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3);
                        ">🔄</button>
                        <button id="flip-vertical-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
                            ...
                            box-shadow: 0 4px 12px rgba(34, 197, 94, 0.3);
                        ">↕️</button>
                        <button id="reset-${modalId}" class="crop-control-btn" style="
                            width: 56px;
                            height: 56px;
                            border-radius: 50%;
                            background: linear-gradient(135deg, #22c55e, #16a34a);
