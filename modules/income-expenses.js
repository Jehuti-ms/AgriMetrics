...
/* ==================== IMPORT RECEIPTS MODAL HEIGHT FIX ==================== */
#import-receipts-modal {
    position: fixed !important;
    top: 0 !important;
    left: 0 !important;
...
.import-receipts-modal-content {
    ...
    min-height: 600px !important; /* Add minimum height */
    display: flex !important;
    flex-direction: column !important;
    overflow: hidden !important;
    position: relative !important;
...
/* BODY - Make it much taller */
.import-receipts-modal-body {
    flex: 1 !important;
    overflow-y: auto !important;
    min-height: 500px !important; /* Increased minimum */
    max-height: calc(90vh - 136px) !important; /* Account for header and footer */
    position: relative !important;
}
...
/* Quick actions section - reduce margin */
.quick-actions-section {
    margin-bottom: 0 !important;
}

/* Recent section - give it space */
.recent-section {
    margin-top: auto !important; /* Push to bottom */
    padding-top: 24px !important;
}

/* Camera section - ensure it fits */
.camera-section {
    flex: 1 !important;
    display: flex !important;
    flex-direction: column !important;
    min-height: 450px !important; /* Give camera enough space */
}
...
/* Override inline style on process button */
#process-receipts-btn {
...
@media (min-width: 1200px) {
    ...
    .import-receipts-modal-body {
        max-height: calc(85vh - 136px) !important;
...
@media (min-width: 768px) and (max-width: 1199px) {
    ...
    /* Adjust camera preview for medium screens */
    .camera-preview-container {
        max-height: 350px !important;
    }
    
    /* Stack action buttons on medium screens if needed */
    .modal-footer-buttons {
        flex-wrap: nowrap !important;
    }
}

/* Small screens - Make it full height */
@media (max-width: 767px) {
    #import-receipts-modal {
...
@media (max-width: 480px) {
    ...
    .import-receipts-modal-body {
        max-height: calc(98vh - 112px) !important;
...
/* Camera glass card - make it fill space */
...
/* Camera preview container - flexible height */
.camera-preview-container {
    flex: 1 !important;
...
/* Recent receipts list - scrollable if too many */
.receipts-list {
