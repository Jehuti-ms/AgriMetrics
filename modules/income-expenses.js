...
.popout-modal {
    ...
    padding: 20px;
    box-sizing: border-box;
    overflow-y: auto; /* ADD: Make entire modal scrollable */
}
...
.popout-modal-content {
    ...
    margin-bottom: 20px; /* ADD: Bottom margin for scrolling */
}
...
@media (max-width: 900px) {
    .popout-modal {
        align-items: flex-start !important; /* Already flex-start, but ensure */
        padding-top: 10px !important; /* Reduced top padding */
    }
    
    .popout-modal-content {
        margin-top: 10px !important; /* Reduced margin */
        max-height: 95vh; /* Slightly taller */
    }
}
...
@media (max-width: 768px) {
    .popout-modal {
        padding: 0 15px 15px !important; /* Remove top padding, keep sides/bottom */
    }
...
/* Very small phones (400px and below) - full screen with no padding */
@media (max-width: 400px) {
    .popout-modal {
        padding: 0 !important;
    }
